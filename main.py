...
def display_full_note_window(note):
    ...
    layout_full_note = [
        ...
        [sg.Multiline(f'Content:\n{content}', size=(40, 10), key='content_display', disabled=True)],
...
def display_notes_with_pagination(notes):
    ...
    while True:
        ...
        for note in notes_to_display:
            ...
            layout.append([sg.Multiline(f'Content:\n{short_content}', size=(40, 5), key='content_display', disabled=True)])
